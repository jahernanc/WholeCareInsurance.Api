...
**Relación con §27.2 (preview de `.docx`):** ya no se pueden subir nuevos `.docx` al sistema — el punto §27.2 queda sin sentido para uploads futuros. **No cierra §27.2 automáticamente**: no se verificó (sin acceso a la base) si ya existen `.docx` subidos previamente que seguirían necesitando preview. Ver nota cruzada en §27.2.
