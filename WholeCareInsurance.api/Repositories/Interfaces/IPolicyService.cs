...
namespace WholeCareInsurance.api.Services
{
    public interface IPolicyService
    {
        ...
        Task<List<Policy>> Search(int? customerId, string? firstName, string? lastName, string? policyNumber, string? status, string? type, string? insuranceCompany, int? period);
