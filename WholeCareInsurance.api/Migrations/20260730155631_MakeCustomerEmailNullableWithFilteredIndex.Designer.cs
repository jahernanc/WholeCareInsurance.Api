...
namespace WholeCareInsurance.api.Migrations
{
    ...
    [Migration("20260730155631_MakeCustomerEmailNullableWithFilteredIndex")]
    partial class MakeCustomerEmailNullableWithFilteredIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WholeCareInsurance.api.Models.CustomerRelationship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DependentCustomerId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TitularCustomerId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("DependentCustomerId");

                    b.HasIndex("TitularCustomerId", "DependentCustomerId")
                        .IsUnique();
            ...
            modelBuilder.Entity("WholeCareInsurance.api.Models.CustomerRelationship", b =>
                {
                    b.HasOne("WholeCareInsurance.api.Models.Customer", "DependentCustomer")
                        .WithMany()
                        .HasForeignKey("DependentCustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WholeCareInsurance.api.Models.Customer", "TitularCustomer")
                        .WithMany()
                        .HasForeignKey("TitularCustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DependentCustomer");

                    b.Navigation("TitularCustomer");
                });
